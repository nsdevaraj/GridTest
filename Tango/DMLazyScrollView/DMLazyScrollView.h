...
@property (readonly)            NSUInteger                      nextPg;
@property (readonly)            NSUInteger                      prevPg;
@property (readonly)            DMLazyScrollViewDirection       direction;

@property (nonatomic,assign)  BOOL            circularScrollEnabled;
@property (nonatomic,assign)  BOOL            backScrollEnabled;
@property (nonatomic,assign)  BOOL            frontScrollEnabled;
@property (nonatomic,assign)  BOOL            movesForward;
